...
% Configurazione opzionale per rendere i link blu e senza rettangoli
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
    urlcolor=blue,
...
\author{Michele Bonomi \\ \url{https://github.com/ohhmeco/GeometryProcessing}}
\date{January 2026}
...
\begin{center}
  \includegraphics[scale=0.25]{../Lab4/Images/screenshot_20260106_191454.png}
\end{center}
